...
const actionLabels: Record<string, string> = {
  ...
  cashflow_bulk_imported: 'Cashflow Diimport',
  cashflow_raw_material_imported: 'Bahan Baku Diimport',
  cashflow_raw_material_updated: 'Bahan Baku Diupdate',
...
const actionColors: Record<string, string> = {
  ...
  cashflow_bulk_imported: 'bg-purple-100 text-purple-700',
  cashflow_raw_material_imported: 'bg-orange-100 text-orange-700',
  cashflow_raw_material_updated: 'bg-amber-100 text-amber-700',
